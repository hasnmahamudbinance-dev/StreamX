        ...
        <TabsContent value="account" className="space-y-6">
          ...
          <Card className="bg-card border-border">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-sm">Download a copy of all your data</CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">Export My Data</p>
                  <p className="text-xs text-muted-foreground">Download all your data including profile, watchlist, history, ratings, and reviews</p>
                </div>
                <Button variant="outline" onClick={async () => {
                  ...
                  try {
                    ...
                    a.href = url;
                    a.download = `streamx-data-export-${new Date().toISOString().split('T')[0]}.json`;
                    a.click();
                ...
                }} disabled={exportingData} className="gap-2">
